...
class student_manager {
  ...
  add_student(name: string) {
    ...
    console.log(
      `Student: ${name} added sucessfully. Student ID: ${studnt.id}.`
    );
  }
  ...
  //method to display student status
  show_studentstatus(student_id: number) {
    let student = this.find_student(student_id);
    if (student) {
      student.show_status();
    }
  ...
  while (true) {
    ...
    switch (choice.choice) {
      ...
      case "Pay Fees":
        ...
        student_managr.pay_studentfees(
